                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">
                      {clienta.total_sesiones} reserva{clienta.total_sesiones === 1 ? '' : 's'}
                    </p>
                  </div>
                  <div className="text-right flex-shrink-0">
                    <p className="text-sm font-semibold text-gray-900">{clienta.gasto_acumulado}€</p>
                    {clienta.bloqueada ? (
                      <span className="inline-flex mt-1 px-2 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-700">
                        Bloqueada
                      </span>
                    ) : (
                      <span className={`inline-flex mt-1 px-2 py-0.5 rounded-full text-xs font-medium ${tipo.class}`}>
                        {tipo.label}
                      </span>
                    )}
                  </div>
