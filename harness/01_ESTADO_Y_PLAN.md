...
- [ ] **12.1 La campana de notificaciones no funciona / no navega (los 3 roles).** El usuario reporta que el botón de notificaciones "no funciona" en masajista y cliente, y que en admin al pulsar una notificación debería llevarte a la sección correspondiente. Hacer en `src/components/Header.tsx`:
